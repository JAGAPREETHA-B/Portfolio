...
!function (e) {
    ...
    function e(e, t) {
        return t = t || T,
            R.test(e) ? t.getElementsByClassName(e.slice(1)) : V.test(e) ? t.getElementsByTagName(e) : t.querySelectorAll(e)
    }
    function t(e) {
        if (!M) {
            var t = (M = T.implementation.createHTMLDocument()).createElement("base");
            t.href = T.location.href,
                M.head.appendChild(t)
        }
        return M.body.innerHTML = e,
            M.body.childNodes
    }
    function i(e) {
    ...
    function n(n, s) {
        ...
        var a, o = n, r = 0;
        if (I(n))
            o = P.test(n) ? T.getElementById(n.slice(1)) : H.test(n) ? t(n) : e(n, s);
        else if (A(n))
            return i(n),
                this;
        if (!o)
        ...
        if (o.nodeType || o === L)
            ...
            for (a = this.length = o.length; r < a; r++)
                this[r] = o[r];
        return this
    }
    function s(e, t) {
    ...
    function r(e) {
        return I(e) ? o : e.cash ? function (t) {
            return e.is(t)
        }
            : function (e, t) {
                return e === t
    ...
    function l(e) {
        return s(S.call(e).filter(function (e, t, i) {
    ...
    function d(e, t) {
        var i = h(e);
        return void 0 === i[t] && (i[t] = e.dataset ? e.dataset[t] : s(e).attr("data-" + t)),
            i[t]
    }
    function c(e, t) {
        var i = h(e);
        i ? delete i[t] : e.dataset ? delete e.dataset[t] : s(e).removeAttr("data-" + name)
    }
    function p(e) {
        return I(e) && e.match(F)
    }
    function v(e, t) {
    ...
    function y(e, t, i) {
        var n = d(e, "_cashEvents") || u(e, "_cashEvents", {});
        n[t] = n[t] || [],
            n[t].push(i),
            e.addEventListener(t, i)
    }
    function _(e, t, i) {
        var n, s = d(e, "_cashEvents"), o = s && s[t];
        o && (i ? (e.removeEventListener(t, i),
            (n = o.indexOf(i)) >= 0 && o.splice(n, 1)) : (a(o, function (i) {
    ...
    function x(e, t, i) {
        var n = I(t);
        n || !t.length ? a(e, n ? function (e) {
            return e.insertAdjacentHTML(i ? "afterbegin" : "beforeend", t)
        }
            : function (e, n) {
                return E(e, 0 === n ? t : t.cloneNode(!0), i)
            }
        ) : a(t, function (t) {
            return x(e, t, i)
        })
    }
    var M, T = document, L = window, $ = Array.prototype, S = $.slice, B = $.filter, D = $.push, O = function () { }, A = function (e) {
        return typeof e == typeof O && e.call
    }, I = function (e) {
        return "string" == typeof e
    }, P = /^#[\w-]*$/, R = /^\.[\w-]*$/, H = /<.+>/, V = /^\w+$/, W = s.fn = s.prototype = n.prototype = {
        cash: !0,
        length: 0,
        push: D,
        splice: $.splice,
    ...
    Object.defineProperty(W, "constructor", {
        value: s
    }),
        s.parseHTML = t,
        s.noop = O,
        ...
        s.extend = W.extend = function (e) {
            ...
            for (1 === t.length && (e = this,
                ...
                if (t[n])
                    for (var s in t[n])
                        t[n].hasOwnProperty(s) && (e[s] = t[n][s]);
            return e
        }
        ,
        s.extend({
            merge: function (e, t) {
                for (var i = +t.length, n = e.length, s = 0; s < i; n++,
                    s++)
                    e[n] = t[s];
                return e.length = n,
                    e
    ...
    var q = s.uid = "_cash" + Date.now();
    W.extend({
        data: function (e, t) {
            if (I(e))
                return void 0 === t ? d(this[0], e) : this.each(function (i) {
                    return u(i, e, t)
                });
            for (var i in e)
                this.data(i, e[i]);
    ...
    W.extend({
        ...
        attr: function (e, t) {
            if (e) {
                if (I(e))
                    return void 0 === t ? this[0] ? this[0].getAttribute ? this[0].getAttribute(e) : this[0][e] : void 0 : this.each(function (i) {
        ...
        prop: function (e, t) {
            if (I(e))
                return void 0 === t ? this[0][e] : this.each(function (i) {
                    i[e] = t
                });
            for (var i in e)
                this.prop(i, e[i]);
    ...
    var N = function () {
        ...
        , z = function () {
            ...
            return function (i) {
                ...
                return a((i + " " + ["webkit", "moz", "ms", "o"].join(n + " ") + n).split(" "), function (n) {
                    if (n in t)
                        return e[n] = i = e[i] = n,
                            !1
                }),
    ...
    s.prefixedProp = z,
                ...
                if (I(e))
                    return e = z(e),
                        arguments.length > 1 ? this.each(function (i) {
                            return i.style[e] = t
                        }) : L.getComputedStyle(this[0])[e];
                for (var i in e)
                    this.css(i, e[i]);
                return this
            }
        }),
        a(["Width", "Height"], function (e) {
            var t = e.toLowerCase();
            W[t] = function () {
                ...
                ,
                W["outer" + e] = function (t) {
                    return this[0]["offset" + e] + (t ? g(this, "margin" + ("Width" === e ? "Left" : "Top")) + g(this, "margin" + ("Width" === e ? "Right" : "Bottom")) : 0)
                }
        }),
        W.extend({
            off: function (e, t) {
        ...
        W.extend({
            serialize: function () {
                var e = "";
                return a(this[0].elements || this, function (t) {
            ...
            val: function (e) {
                return void 0 === e ? C(this[0]) : this.each(function (t) {
                    return t.value = e
                })
            }
        }),
        W.extend({
            ...
            before: function (e) {
                return s(e).insertBefore(this),
                    this
            },
            clone: function () {
                return s(this.map(function (e) {
    ...
    return W.extend({
        ...
        offset: function () {
            ...
            return {
                top: e.top + L.pageYOffset - j.clientTop,
                left: e.left + L.pageXOffset - j.clientLeft
            }
        },
        ...
        W.extend({
            ...
            closest: function (e) {
                return !e || this.length < 1 ? s() : this.is(e) ? this.filter(e) : this.parent().closest(e)
            },
            is: function (e) {
                if (!e)
                    return !1;
            ...
            find: function (t) {
                if (!t || t.nodeType)
                    return s(t && this.has(t).length ? t : null);
                var i = [];
                return this.each(function (n) {
                    D.apply(i, e(t, n))
                }),
            ...
            parents: function (e) {
                var t, i = [];
                return this.each(function (n) {
                    for (t = n; t && t.parentNode && t !== T.body.parentNode;)
                        t = t.parentNode,
                            (!e || e && o(t, e)) && i.push(t)
                }),
                    l(i)
        ...
        if (!e.jQuery) {
            ...
            i.isWindow = function (e) {
                ...
                i.each = function (e, i, n) {
                    ...
                    if (n) {
                        if (o)
                            for (; s < a && !1 !== i.apply(e[s], n); s++)
                                ;
                        else
                            for (s in e)
                                if (e.hasOwnProperty(s) && !1 === i.apply(e[s], n))
                                    break
                    } else if (o)
                        for (; s < a && !1 !== i.call(e[s], s, e[s]); s++)
                            ;
                    else
                        for (s in e)
                            if (e.hasOwnProperty(s) && !1 === i.call(e[s], s, e[s]))
                                break;
                    return e
                }
                ,
                ...
                ,
                i.extend = function () {
                    var e, t, n, s, a, o, r = arguments[0] || {}, l = 1, h = arguments.length, u = !1;
                    for ("boolean" == typeof r && (u = r,
                        ...
                        if (a = arguments[l])
                            for (s in a)
                                a.hasOwnProperty(s) && (e = r[s],
                                    n = a[s],
                                    r !== n && (u && n && (i.isPlainObject(n) || (t = i.isArray(n))) ? (t ? (t = !1,
                                        o = e && i.isArray(e) ? e : []) : o = e && i.isPlainObject(e) ? e : {},
                                        r[s] = i.extend(u, o, n)) : void 0 !== n && (r[s] = n)));
                    return r
                }
                ,
                i.queue = function (e, n, s) {
                    if (e) {
                        n = (n || "fx") + "queue";
                        var a = i.data(e, n);
                        return s ? (!a || i.isArray(s) ? a = i.data(e, n, function (e, i) {
                            var n = i || [];
                            return e && (t(Object(e)) ? function (e, t) {
                                for (var i = +t.length, n = 0, s = e.length; n < i;)
                                    e[s++] = t[n++];
                                if (i !== i)
                                    for (; void 0 !== t[n];)
                                        e[s++] = t[n++];
                ...
                i.fn = i.prototype = {
                    ...
                    position: function () {
                        ...
                        return n.top -= parseFloat(e.style.marginTop) || 0,
                            ...
                            t.style && (s.top += parseFloat(t.style.borderTopWidth) || 0,
                                s.left += parseFloat(t.style.borderLeftWidth) || 0),
                        {
                            top: n.top - s.top,
                            left: n.left - s.left
                        }
        ...
        return function (e, t, i, n) {
            ...
            function u(e, i, n, s) {
                ...
                function c(t, i, s) {
                    var a, o, r = 0;
                    do {
                        (a = l(o = i + (s - i) / 2, e, n) - t) > 0 ? s = o : i = o
                    } while (Math.abs(a) > g && ++r < y);
                    return o
                }
                function p(t) {
                    for (var i = 0, s = 1, a = _ - 1; s !== a && C[s] <= t; ++s)
                        i += k;
                    var o = i + (t - C[--s]) / (C[s + 1] - C[s]) * k
                        , r = h(o, e, n);
                    return r >= m ? u(t, o) : 0 === r ? o : c(t, i, i + k)
                }
                function v() {
                    E = !0,
                        e === i && n === s || d()
                ...
                e = Math.min(e, 1),
                    ...
                    e = Math.max(e, 0),
                    n = Math.max(n, 0);
                var C = b ? new Float32Array(_) : new Array(_)
                    , E = !1
                    , x = function (t) {
                        return E || v(),
                            e === i && n === s ? t : 0 === t ? 0 : 1 === t ? 1 : l(p(t), i, s)
                    };
            ...
            function d(e, t) {
                var i = e;
                return _.isString(e) ? C.Easings[e] || (i = !1) : i = _.isArray(e) && 1 === e.length ? h.apply(null, e) : _.isArray(e) && 2 === e.length ? E.apply(null, e.concat([t])) : !(!_.isArray(e) || 4 !== e.length) && u.apply(null, e),
                    !1 === i && (i = C.Easings[C.defaults.easing] ? C.defaults.easing : w),
                    i
            }
            function c(e) {
                if (e) {
                    ...
                    i > 1e4 && (C.State.calls = s(C.State.calls),
                        i = C.State.calls.length);
                    for (var a = 0; a < i; a++)
                        if (C.State.calls[a]) {
                            var r = C.State.calls[a]
                                , l = r[0]
                                , h = r[2]
                                , u = r[3]
                                , d = !!u
                                ...
                                , y = r[5]
                                , k = r[6];
                            if (u || (u = C.State.calls[a][3] = t - 16),
                                y) {
                                if (!0 !== y.resume)
                                    continue;
                                u = r[3] = Math.round(t - k - 16),
                                    r[5] = null
                            }
                            k = r[6] = t - u;
                            for (var b = Math.min(k / h.duration, 1), w = 0, E = l.length; w < E; w++) {
                                var M = l[w]
                                    , L = M.element;
                                if (o(L)) {
                                    var $ = !1;
                                    if (h.display !== n && null !== h.display && "none" !== h.display) {
                                        if ("flex" === h.display) {
                                            ...
                                            v.each(S, function (e, t) {
                                                x.setPropertyValue(L, "display", t)
                                            })
                                        }
                                        x.setPropertyValue(L, "display", h.display)
                                    }
                                    h.visibility !== n && "hidden" !== h.visibility && x.setPropertyValue(L, "visibility", h.visibility);
                                    for (var B in M)
                                        if (M.hasOwnProperty(B) && "element" !== B) {
                                            var D, O = M[B], A = _.isString(O.easing) ? C.Easings[O.easing] : O.easing;
                                            if (_.isString(O.pattern)) {
                                                var I = 1 === b ? function (e, t, i) {
                                                    var n = O.endValue[t];
                                                    ...
                                                    ;
                                                D = O.pattern.replace(/{(\d+)(!)?}/g, I)
                                            } else if (1 === b)
                                                D = O.endValue;
                                            else {
                                                var P = O.endValue - O.startValue;
                                                D = O.startValue + P * A(b, h, P)
                                            }
                                            if (!d && D === O.currentValue)
                                                continue;
                                            if (O.currentValue = D,
                                                "tween" === B)
                                                m = D;
                                                ...
                                                var R;
                                                if (x.Hooks.registered[B]) {
                                                    R = x.Hooks.getRoot(B);
                                                    var H = o(L).rootPropertyValueCache[R];
                                                    H && (O.rootPropertyValue = H)
                                                }
                                                var V = x.setPropertyValue(L, B, O.currentValue + (f < 9 && 0 === parseFloat(D) ? "" : O.unitType), O.rootPropertyValue, O.scrollData);
                                                x.Hooks.registered[B] && (x.Normalizations.registered[R] ? o(L).rootPropertyValueCache[R] = x.Normalizations.registered[R]("extract", null, V[1]) : o(L).rootPropertyValueCache[R] = V[1]),
                                                    "transform" === V[0] && ($ = !0)
                                            }
                                        }
                                    h.mobileHA && o(L).transformCache.translate3d === n && (o(L).transformCache.translate3d = "(0px, 0px, 0px)",
                                        $ = !0),
                                        $ && x.flushTransformCache(L)
                                }
                            }
                            h.display !== n && "none" !== h.display && (C.State.calls[a][2].display = !1),
                                h.visibility !== n && "hidden" !== h.visibility && (C.State.calls[a][2].visibility = !1),
                                h.progress && h.progress.call(r[1], r[1], b, Math.max(0, u + h.duration - t), u, m),
                                1 === b && p(a)
                        }
                }
                C.State.isTicking && T(c)
            }
            function p(e, t) {
                if (!C.State.calls[e])
                    return !1;
                for (var i = C.State.calls[e][0], s = C.State.calls[e][1], a = C.State.calls[e][2], r = C.State.calls[e][4], l = !1, h = 0, u = i.length; h < u; h++) {
                    var d = i[h].element;
                    t || a.loop || ("none" === a.display && x.setPropertyValue(d, "display", a.display),
                        "hidden" === a.visibility && x.setPropertyValue(d, "visibility", a.visibility));
                    var c = o(d);
                    if (!0 !== a.loop && (v.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(v.queue(d)[1])) && c) {
                        c.isAnimating = !1,
                            c.rootPropertyValueCache = {};
                        var p = !1;
                        v.each(x.Lists.transforms3D, function (e, t) {
                            var i = /^scale/.test(t) ? 1 : 0
                                , s = c.transformCache[t];
                            c.transformCache[t] !== n && new RegExp("^\\(" + i + "[^.]").test(s) && (p = !0,
                                delete c.transformCache[t])
                        }),
                            a.mobileHA && (p = !0,
                                delete c.transformCache.translate3d),
                            p && x.flushTransformCache(d),
                            x.Values.removeClass(d, "velocity-animating")
                    }
                    if (!t && a.complete && !a.loop && h === u - 1)
                        try {
                            a.complete.call(s, s)
                        } catch (e) {
                            setTimeout(function () {
                    ...
                    r && !0 !== a.loop && r(s),
                        c && !0 === a.loop && !t && (v.each(c.tweensContainer, function (e, t) {
                        ...
                        !1 !== a.queue && v.dequeue(d, a.queue)
                }
                C.State.calls[e] = !1;
                for (var f = 0, m = C.State.calls.length; f < m; f++)
                    if (!1 !== C.State.calls[f]) {
                        l = !0;
                        break
                    }
            ...
            var v, f = function () {
                ...
                isWrapped: function (e) {
                    return e && _.isNumber(e.length) && !_.isString(e) && !_.isFunction(e) && !_.isNode(e) && (0 === e.length || _.isNode(e[0]))
                },
                isSVG: function (e) {
            ...
            if (e.fn && e.fn.jquery ? (v = e,
                k = !0) : v = t.Velocity.Utilities,
                f <= 8 && !k)
                throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            {
                if (!(f <= 7)) {
                    var b = 400
                        ...
                        , C = {
                            ...
                            pauseAll: function (e) {
                                ...
                                v.each(C.State.calls, function (t, i) {
                                    if (i) {
                                    ...
                                    v.each(C.State.delayedElements, function (e, i) {
                                        i && r(i, t)
                                    })
                            },
                            resumeAll: function (e) {
                                ...
                                v.each(C.State.calls, function (t, i) {
                                    ...
                                    v.each(C.State.delayedElements, function (e, t) {
                                        t && l(t)
                                    })
                            }
                        };
                    t.pageYOffset !== n ? (C.State.scrollAnchor = t,
                    ...
                    var x = C.CSS = {
                        ...
                        Hooks: {
                                ...
                                if (f)
                                    for (i in x.Hooks.templates)
                                        if (x.Hooks.templates.hasOwnProperty(i)) {
                                            s = (n = x.Hooks.templates[i])[0].split(" ");
                                            var a = n[1].match(x.RegEx.valueSplit);
                                            "Color" === s[0] && (s.push(s.shift()),
                                                a.push(a.shift()),
                                                x.Hooks.templates[i] = [s.join(" "), a.join(" ")])
                                        }
                                for (i in x.Hooks.templates)
                                    if (x.Hooks.templates.hasOwnProperty(i)) {
                                        s = (n = x.Hooks.templates[i])[0].split(" ");
                            ...
                            getUnit: function (e, t) {
                                ...
                                return i && x.Lists.units.indexOf(i) >= 0 ? i : ""
                            },
                            ...
                            extractValue: function (e, t) {
                                ...
                                if (i) {
                                    var n = i[0]
                                        , s = i[1];
                                    return (t = x.Hooks.cleanRootPropertyValue(n, t)).toString().match(x.RegEx.valueSplit)[s]
                                }
                                return t
                            },
                            injectValue: function (e, t, i) {
                                ...
                                if (n) {
                                    var s, a = n[0], o = n[1];
                                    return i = x.Hooks.cleanRootPropertyValue(a, i),
                                        s = i.toString().match(x.RegEx.valueSplit),
                                        s[o] = t,
                                        s.join(" ")
                                }
                                return i
                            ...
                            register: function () {
                                function e(e, t, i) {
                                    if ("border-box" === x.getPropertyValue(t, "boxSizing").toString().toLowerCase() === (i || !1)) {
                                        var n, s, a = 0, o = "width" === e ? ["Left", "Right"] : ["Top", "Bottom"], r = ["padding" + o[0], "padding" + o[1], "border" + o[0] + "Width", "border" + o[1] + "Width"];
                                        for (n = 0; n < r.length; n++)
                                            s = parseFloat(x.getPropertyValue(t, r[n])),
                                                isNaN(s) || (a += s);
                                        return i ? -a : a
                                    }
                                    return 0
                                    ...
                                    return function (n, s, a) {
                                        switch (n) {
                                            case "name":
                                                return t;
                                            case "extract":
                                                return parseFloat(a) + e(t, s, i);
                                            case "inject":
                                                return parseFloat(a) - e(t, s, i) + "px"
                                        }
                                    }
                                }
                                f && !(f > 9) || C.State.isGingerbread || (x.Lists.transformsBase = x.Lists.transformsBase.concat(x.Lists.transforms3D));
                                for (var i = 0; i < x.Lists.transformsBase.length; i++)
                                    !function () {
                                        var e = x.Lists.transformsBase[i];
                                            ...
                                            switch (t) {
                                                ...
                                                case "inject":
                                                    ...
                                                    switch (e.substr(0, e.length - 1)) {
                                                        ...
                                                        case "scal":
                                                        case "scale":
                                                            C.State.isAndroid && o(i).transformCache[e] === n && s < 1 && (s = 1),
                                                                a = !/(\d)$/i.test(s);
                                                            break;
                                                        case "skew":
                                                            a = !/(deg|\d)$/i.test(s);
                                                    ...
                                                    return a || (o(i).transformCache[e] = "(" + s + ")"),
                                                        o(i).transformCache[e]
                                            }
                                        }
                                    }();
                                for (var s = 0; s < x.Lists.colors.length; s++)
                                    !function () {
                                        var e = x.Lists.colors[s];
                                        x.Normalizations.registered[e] = function (t, i, s) {
                                            switch (t) {
                                                case "name":
                                                    return e;
                                                case "extract":
                                                    var a;
                                                    if (x.RegEx.wrappedValueAlreadyExtracted.test(s))
                                                        a = s;
                                                    else {
                                                        var o, r = {
                                                            black: "rgb(0, 0, 0)",
                                                        ...
                                                        /^[A-z]+$/i.test(s) ? o = r[s] !== n ? r[s] : r.black : x.RegEx.isHex.test(s) ? o = "rgb(" + x.Values.hexToRgb(s).join(" ") + ")" : /^rgba?\(/i.test(s) || (o = r.black),
                                                            a = (o || s).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                                    }
                                                    return (!f || f > 8) && 3 === a.split(" ").length && (a += " 1"),
                                                        a;
                                                case "inject":
                                                    return /^rgb/.test(s) ? s : (f <= 8 ? 4 === s.split(" ").length && (s = s.split(/\s+/).slice(0, 3).join(" ")) : 3 === s.split(" ").length && (s += " 1"),
                                                        (f <= 8 ? "rgb" : "rgba") + "(" + s.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")")
                                            }
                                        }
                                    }();
                        ...
                        Names: {
                            ...
                            SVGAttribute: function (e) {
                                ...
                                return (f || C.State.isAndroid && !C.State.isChrome) && (t += "|transform"),
                            ...
                            prefixCheck: function (e) {
                                ...
                                for (var t = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = t.length; i < n; i++) {
                                    ...
                                    if (s = 0 === i ? e : t[i] + e.replace(/^\w/, function (e) {
                                        ...
                                        _.isString(C.State.prefixElement.style[s]))
                                        return C.State.prefixMatches[e] = s,
                                            [s, !0]
                                }
                                return [e, !1]
                            }
                        ...
                        Values: {
                            hexToRgb: function (e) {
                                ...
                                return e = e.replace(i, function (e, t, i, n) {
                                    ...
                                    (t = n.exec(e)) ? [parseInt(t[1], 16), parseInt(t[2], 16), parseInt(t[3], 16)] : [0, 0, 0]
                            },
                        ...
                        getPropertyValue: function (e, i, s, a) {
                            function r(e, i) {
                                ...
                                if (f <= 8)
                                    ...
                                    var l = !1;
                                    /^(width|height)$/.test(i) && 0 === x.getPropertyValue(e, "display") && (l = !0,
                                    ...
                                    var c;
                                    c = o(e) === n ? t.getComputedStyle(e, null) : o(e).computedStyle ? o(e).computedStyle : o(e).computedStyle = t.getComputedStyle(e, null),
                                        "borderColor" === i && (i = "borderTopColor"),
                                        "" !== (s = 9 === f && "filter" === i ? c.getPropertyValue(i) : c[i]) && null !== s || (s = e.style[i]),
                                        h()
                                }
                                if ("auto" === s && /^(top|right|bottom|left)$/i.test(i)) {
                                    var p = r(e, "position");
                                    ("fixed" === p || "absolute" === p && /top|left/i.test(i)) && (s = v(e).position()[i] + "px")
                                }
                                return s
                            }
                            var l;
                            if (x.Hooks.registered[i]) {
                                var h = i
                                    , u = x.Hooks.getRoot(h);
                                s === n && (s = x.getPropertyValue(e, x.Names.prefixCheck(u)[0])),
                                    x.Normalizations.registered[u] && (s = x.Normalizations.registered[u]("extract", e, s)),
                                    l = x.Hooks.extractValue(h, s)
                            } else if (x.Normalizations.registered[i]) {
                                var d, c;
                                "transform" !== (d = x.Normalizations.registered[i]("name", e)) && (c = r(e, x.Names.prefixCheck(d)[0]),
                                    x.Values.isCSSNullValue(c) && x.Hooks.templates[i] && (c = x.Hooks.templates[i][1])),
                                    l = x.Normalizations.registered[i]("extract", e, c)
                            }
                            if (!/^[\d-]/.test(l)) {
                                var p = o(e);
                                if (p && p.isSVG && x.Names.SVGAttribute(i))
                        ...
                        setPropertyValue: function (e, i, n, s, a) {
                            ...
                            if ("scroll" === i)
                                ...
                                if (x.Hooks.registered[i]) {
                                    var l = i
                                        , h = x.Hooks.getRoot(i);
                                    s = s || x.getPropertyValue(e, h),
                                        n = x.Hooks.injectValue(l, n, s),
                                        i = h
                                }
                                if (x.Normalizations.registered[i] && (n = x.Normalizations.registered[i]("inject", e, n),
                                    i = x.Normalizations.registered[i]("name", e)),
                                    r = x.Names.prefixCheck(i)[0],
                                    f <= 8)
                                    try {
                                        e.style[r] = n
                                    } catch (e) {
                                        C.debug && console.log("Browser does not support [" + n + "] for [" + r + "]")
                                    }
                                else {
                                    var u = o(e);
                                    u && u.isSVG && x.Names.SVGAttribute(i) ? e.setAttribute(i, n) : e.style[r] = n
                                }
                                C.debug >= 2 && console.log("Set " + i + " (" + r + "): " + n)
                            }
                            return [r, n]
                        },
                        flushTransformCache: function (e) {
                            var t = ""
                                , i = o(e);
                            if ((f || C.State.isAndroid && !C.State.isChrome) && i && i.isSVG) {
                                var n = function (t) {
                                ...
                                v.each(o(e).transformCache, function (e) {
                                ...
                                var a, r;
                                v.each(o(e).transformCache, function (i) {
                                    return a = o(e).transformCache[i],
                                        "transformPerspective" === i ? (r = a,
                                            !0) : (9 === f && "rotateZ" === i && (i = "rotate"),
                                                void (t += i + a + " "))
                                }),
                                    r && (t = "perspective" + r + " " + t)
                            }
                        ...
                        C.hook = function (e, t, i) {
                            ...
                            return e = a(e),
                                v.each(e, function (e, a) {
                                    if (o(a) === n && C.init(a),
                                        i === n)
                                        s === n && (s = x.getPropertyValue(a, t));
                                    else {
                                        var r = x.setPropertyValue(a, t, i);
                                        "transform" === r[0] && C.CSS.flushTransformCache(a),
                                            s = r
                                    }
                                }),
                                s
                    ...
                    var M = function () {
                        ...
                        function s(e, s) {
                            function a(a) {
                                ...
                                if ("scroll" === S) {
                                    var f, m, b, w = /^x$/i.test(l.axis) ? "Left" : "Top", M = parseFloat(l.offset) || 0;
                                    l.container ? _.isWrapped(l.container) || _.isNode(l.container) ? (l.container = l.container[0] || l.container,
                                        f = l.container["scroll" + w],
                                        b = f + v(e).position()[w.toLowerCase()] + M) : l.container = null : (f = C.State.scrollAnchor[C.State["scrollProperty" + w]],
                                            m = C.State.scrollAnchor[C.State["scrollProperty" + ("Left" === w ? "Top" : "Left")]],
                                            b = v(e).offset()[w.toLowerCase()] + M),
                                        h = {
                                            scroll: {
                                                rootPropertyValue: !1,
                                                startValue: f,
                                        ...
                                        C.debug && console.log("tweensContainer (scroll): ", h.scroll, e)
                                } else if ("reverse" === S) {
                                    if (!(u = o(e)))
                                        return;
                                    if (!u.tweensContainer)
                                        return void v.dequeue(e, l.queue);
                                    "none" === u.opts.display && (u.opts.display = "auto"),
                                        "hidden" === u.opts.visibility && (u.opts.visibility = "visible"),
                                        u.opts.loop = !1,
                                        u.opts.begin = null,
                                        u.opts.complete = null,
                                        k.easing || delete l.easing,
                                        k.duration || delete l.duration,
                                        l = v.extend({}, u.opts, l),
                                        p = v.extend(!0, {}, u ? u.tweensContainer : null);
                                    for (var $ in p)
                                        if (p.hasOwnProperty($) && "element" !== $) {
                                            var B = p[$].startValue;
                                            p[$].startValue = p[$].currentValue = p[$].endValue,
                                                p[$].endValue = B,
                                                _.isEmptyObject(k) || (p[$].easing = l.easing),
                                                C.debug && console.log("reverse tweensContainer (" + $ + "): " + JSON.stringify(p[$]), e)
                                        }
                                    h = p
                                } else if ("start" === S) {
                                    (u = o(e)) && u.tweensContainer && !0 === u.isAnimating && (p = u.tweensContainer);
                                    var D = function (s, a) {
                                        var o, d = x.Hooks.getRoot(s), c = !1, f = a[0], m = a[1], g = a[2];
                                        if (u && u.isSVG || "tween" === d || !1 !== x.Names.prefixCheck(d)[1] || x.Normalizations.registered[d] !== n) {
                                            (l.display !== n && null !== l.display && "none" !== l.display || l.visibility !== n && "hidden" !== l.visibility) && /opacity|filter/.test(s) && !g && 0 !== f && (g = 0),
                                                l._cacheValues && p && p[s] ? (g === n && (g = p[s].endValue + p[s].unitType),
                                                    c = u.rootPropertyValueCache[d]) : x.Hooks.registered[s] ? g === n ? (c = x.getPropertyValue(e, d),
                                                        g = x.getPropertyValue(e, s, c)) : c = x.Hooks.templates[d][1] : g === n && (g = x.getPropertyValue(e, s));
                                            var y, k, b, w = !1, E = function (e, t) {
                                                var i, n;
                                            ...
                                            if (g !== f && _.isString(g) && _.isString(f)) {
                                                o = "";
                                                var M = 0
                                                    , T = 0
                                                    , L = []
                                                    ...
                                                    , B = 0
                                                    , D = 0;
                                                for (g = x.Hooks.fixColors(g),
                                                    f = x.Hooks.fixColors(f); M < g.length && T < f.length;) {
                                                    var O = g[M]
                                                        , A = f[T];
                                                    if (/[\d\.]/.test(O) && /[\d\.]/.test(A)) {
                                                        for (var I = O, R = A, H = ".", V = "."; ++M < g.length;) {
                                                            if ((O = g[M]) === H)
                                                                H = "..";
                                                            else if (!/\d/.test(O))
                                                                break;
                                                        ...
                                                        var W = x.Hooks.getUnit(g, M)
                                                            , q = x.Hooks.getUnit(f, T);
                                                        if (M += W.length,
                                                            T += q.length,
                                                            W === q)
                                                            I === R ? o += I + W : (o += "{" + L.length + (B ? "!" : "") + "}" + W,
                                                                L.push(parseFloat(I)),
                                                                $.push(parseFloat(R)));
                                                        else {
                                                            var F = parseFloat(I)
                                                                , N = parseFloat(R);
                                                            o += (S < 5 ? "calc" : "") + "(" + (F ? "{" + L.length + (B ? "!" : "") + "}" : "0") + W + " + " + (N ? "{" + (L.length + (F ? 1 : 0)) + (B ? "!" : "") + "}" : "0") + q + ")",
                                                                F && (L.push(F),
                                                                    $.push(0)),
                                                                N && (L.push(0),
                                                                    $.push(N))
                                                        ...
                                                        o += O,
                                                            M++,
                                                            T++,
                                                            0 === S && "c" === O || 1 === S && "a" === O || 2 === S && "l" === O || 3 === S && "c" === O || S >= 4 && "(" === O ? S++ : (S && S < 5 || S >= 4 && ")" === O && --S < 5) && (S = 0),
                                                            0 === B && "r" === O || 1 === B && "g" === O || 2 === B && "b" === O || 3 === B && "a" === O || B >= 3 && "(" === O ? (3 === B && "a" === O && (D = 1),
                                                                B++) : D && "," === O ? ++D > 3 && (B = D = 0) : (D && B < (D ? 5 : 4) || B >= (D ? 4 : 3) && ")" === O && --B < (D ? 5 : 4)) && (B = D = 0)
                                                    }
                                                }
                                                M === g.length && T === f.length || (C.debug && console.error('Trying to pattern match mis-matched strings ["' + f + '", "' + g + '"]'),
                                                    o = n),
                                                    o && (L.length ? (C.debug && console.log('Pattern found "' + o + '" -> ', L, $, "[" + g + "," + f + "]"),
                                                        g = L,
                                                        f = $,
                                                        k = b = "") : o = n)
                                            }
                                            o || (y = E(s, g),
                                                ...
                                                g = parseFloat(g) || 0,
                                                f = parseFloat(f) || 0,
                                                "%" === k && (/^(fontSize|lineHeight)$/.test(s) ? (f /= 100,
                                                    k = "em") : /^scale/.test(s) ? (f /= 100,
                                                        k = "") : /(Red|Green|Blue)$/i.test(s) && (f = f / 100 * 255,
                                                            k = "")));
                                            if (/[\/*]/.test(w))
                                                k = b;
                                            else if (b !== k && 0 !== g)
                                                if (0 === f)
                                                    ...
                                                    r = r || function () {
                                                        var n = {
                                                            ...
                                                            , s = n.position === P.lastPosition && n.myParent === P.lastParent
                                                            , a = n.fontSize === P.lastFontSize;
                                                        P.lastParent = n.myParent,
                                                            P.lastPosition = n.position,
                                                            P.lastFontSize = n.fontSize;
                                                        var o = 100
                                                            , r = {};
                                                        if (a && s)
                                                            r.emToPx = P.lastEmToPx,
                                                                r.percentToPxWidth = P.lastPercentToPxWidth,
                                                                r.percentToPxHeight = P.lastPercentToPxHeight;
                                                        else {
                                                            var l = u && u.isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                                            C.init(l),
                                                                n.myParent.appendChild(l),
                                                                v.each(["overflow", "overflowX", "overflowY"], function (e, t) {
                                                                    C.CSS.setPropertyValue(l, t, "hidden")
                                                                }),
                                                                C.CSS.setPropertyValue(l, "position", n.position),
                                                                C.CSS.setPropertyValue(l, "fontSize", n.fontSize),
                                                                C.CSS.setPropertyValue(l, "boxSizing", "content-box"),
                                                                v.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (e, t) {
                                                                    C.CSS.setPropertyValue(l, t, o + "%")
                                                                }),
                                                                C.CSS.setPropertyValue(l, "paddingLeft", o + "em"),
                                                                r.percentToPxWidth = P.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(l, "width", null, !0)) || 1) / o,
                                                                r.percentToPxHeight = P.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(l, "height", null, !0)) || 1) / o,
                                                                r.emToPx = P.lastEmToPx = (parseFloat(x.getPropertyValue(l, "paddingLeft")) || 1) / o,
                                                                n.myParent.removeChild(l)
                                                        }
                                                        return null === P.remToPx && (P.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16),
                                                            null === P.vwToPx && (P.vwToPx = parseFloat(t.innerWidth) / 100,
                                                                P.vhToPx = parseFloat(t.innerHeight) / 100),
                                                            r.remToPx = P.remToPx,
                                                            r.vwToPx = P.vwToPx,
                                                            r.vhToPx = P.vhToPx,
                                                            C.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(r), e),
                                                            r
                                                    }();
                                                    var z = /margin|padding|left|right|width|text|word|letter/i.test(s) || /X$/.test(s) || "x" === s ? "x" : "y";
                                                    switch (b) {
                                                        case "%":
                                                            g *= "x" === z ? r.percentToPxWidth : r.percentToPxHeight;
                                                            break;
                                                        case "px":
                                                            break;
                                                        default:
                                                    ...
                                                    switch (k) {
                                                        case "%":
                                                            g *= 1 / ("x" === z ? r.percentToPxWidth : r.percentToPxHeight);
                                                            break;
                                                        case "px":
                                                            break;
                                                        default:
                                            ...
                                            h[s] = {
                                                ...
                                                o && (h[s].pattern = o),
                                                C.debug && console.log("tweensContainer (" + s + "): " + JSON.stringify(h[s]), e)
                                        } else
                                            C.debug && console.log("Skipping [" + d + "] due to a lack of browser support.")
                                    };
                                    for (var O in y)
                                        if (y.hasOwnProperty(O)) {
                                            var A = x.Names.camelCase(O)
                                                , I = function (t, i) {
                                                    var n, a, o;
                                                    return _.isFunction(t) && (t = t.call(e, s, T)),
                                                        _.isArray(t) ? (n = t[0],
                                                            !_.isArray(t[1]) && /^[\d-]/.test(t[1]) || _.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? o = t[1] : _.isString(t[1]) && !x.RegEx.isHex.test(t[1]) && C.Easings[t[1]] || _.isArray(t[1]) ? (a = i ? t[1] : d(t[1], l.duration),
                                                                o = t[2]) : o = t[1] || t[2]) : n = t,
                                                        i || (a = a || l.easing),
                                                        _.isFunction(n) && (n = n.call(e, s, T)),
                                                        _.isFunction(o) && (o = o.call(e, s, T)),
                                                        [n || 0, a, o]
                                                }(y[O]);
                                            if (x.Lists.colors.indexOf(A) >= 0) {
                                                var H = I[0]
                                                    , V = I[1]
                                                    , W = I[2];
                                                if (x.RegEx.isHex.test(H)) {
                                                    for (var q = ["Red", "Green", "Blue"], F = x.Values.hexToRgb(H), N = W ? x.Values.hexToRgb(W) : n, z = 0; z < q.length; z++) {
                                                        var j = [F[z]];
                                                        V && j.push(V),
                                                            N !== n && j.push(N[z]),
                                                            D(A + q[z], j)
                                ...
                                h.element && (x.Values.addClass(e, "velocity-animating"),
                                    R.push(h),
                                    (u = o(e)) && ("" === l.queue && (u.tweensContainer = h,
                                        u.opts = l),
                                        u.isAnimating = !0),
                                    L === T - 1 ? (C.State.calls.push([R, g, l, null, E.resolver, null, 0]),
                                        !1 === C.State.isTicking && (C.State.isTicking = !0,
                                            c())) : L++)
                            }
                            var r, l = v.extend({}, C.defaults, k), h = {};
                            switch (o(e) === n && C.init(e),
                            parseFloat(l.delay) && !1 !== l.queue && v.queue(e, l.queue, function (t) {
                            ...
                            if (!1 !== C.mock && (!0 === C.mock ? l.duration = l.delay = 1 : (l.duration *= parseFloat(C.mock) || 1,
                                ...
                                v.queue(e, l.queue, function (e, t) {
                                    return !0 === t ? (E.promise && E.resolver(g),
                                        !0) : (C.velocityQueueEntryFlag = !0,
                                            void a())
                                });
                            "" !== l.queue && "fx" !== l.queue || "inprogress" === v.queue(e)[0] || v.dequeue(e)
                        }
                        var h, u, f, m, g, y, k, w = arguments[0] && (arguments[0].p || v.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || _.isString(arguments[0].properties));
                        _.isWrapped(this) ? (u = !1,
                            m = 0,
                            g = this,
                            f = this) : (u = !0,
                                m = 1,
                                g = w ? arguments[0].elements || arguments[0].e : arguments[0]);
                        var E = {
                            promise: null,
                            resolver: null,
                            rejecter: null
                        ...
                        {
                            if (u && C.Promise && (E.promise = new C.Promise(function (e, t) {
                                E.resolver = e,
                                    E.rejecter = t
                            }
                            )),
                                w ? (y = arguments[0].properties || arguments[0].p,
                                    k = arguments[0].options || arguments[0].o) : (y = arguments[m],
                                        k = arguments[m + 1]),
                                g = a(g)) {
                                var T = g.length
                                    , L = 0;
                                if (!/^(stop|finish|finishAll|pause|resume)$/i.test(y) && !v.isPlainObject(k)) {
                                    k = {};
                                    for (var $ = m + 1; $ < arguments.length; $++)
                                        _.isArray(arguments[$]) || !/^(fast|normal|slow)$/i.test(arguments[$]) && !/^\d/.test(arguments[$]) ? _.isString(arguments[$]) || _.isArray(arguments[$]) ? k.easing = arguments[$] : _.isFunction(arguments[$]) && (k.complete = arguments[$]) : k.duration = arguments[$]
                                }
                                var S;
                                switch (y) {
                                    case "scroll":
                                    ...
                                    case "pause":
                                        ...
                                        return v.each(g, function (e, t) {
                                            r(t, B)
                                        }),
                                            v.each(C.State.calls, function (e, t) {
                                                var i = !1;
                                                t && v.each(t[1], function (e, s) {
                                                    var a = k === n ? "" : k;
                                                    return !0 !== a && t[2].queue !== a && (k !== n || !1 !== t[2].queue) || (v.each(g, function (e, n) {
                                                        if (n === s)
                                                            return t[5] = {
                                                                resume: !1
                                                            },
                                    ...
                                    case "resume":
                                        return v.each(g, function (e, t) {
                                            ...
                                            v.each(C.State.calls, function (e, t) {
                                                ...
                                                t && v.each(t[1], function (e, s) {
                                                    var a = k === n ? "" : k;
                                                    return !0 !== a && t[2].queue !== a && (k !== n || !1 !== t[2].queue) || !t[5] || (v.each(g, function (e, n) {
                                                        if (n === s)
                                                            return t[5].resume = !0,
                                                                i = !0,
                                                                !1
                                    ...
                                    case "stop":
                                        v.each(g, function (e, t) {
                                            o(t) && o(t).delayTimer && (clearTimeout(o(t).delayTimer.setTimeout),
                                                ...
                                                "finishAll" !== y || !0 !== k && !_.isString(k) || (v.each(v.queue(t, _.isString(k) ? k : ""), function (e, t) {
                                                    _.isFunction(t) && t()
                                                }),
                                                    v.queue(t, _.isString(k) ? k : "", []))
                                        });
                                        var D = [];
                                        return v.each(C.State.calls, function (e, t) {
                                            t && v.each(t[1], function (i, s) {
                                                var a = k === n ? "" : k;
                                                return !0 !== a && t[2].queue !== a && (k !== n || !1 !== t[2].queue) || void v.each(g, function (i, n) {
                                                    if (n === s)
                                                        if ((!0 === k || _.isString(k)) && (v.each(v.queue(n, _.isString(k) ? k : ""), function (e, t) {
                                                            _.isFunction(t) && t(null, !0)
                                                        }),
                                                            v.queue(n, _.isString(k) ? k : "", [])),
                                                            "stop" === y) {
                                                            var r = o(n);
                                                            r && r.tweensContainer && !1 !== a && v.each(r.tweensContainer, function (e, t) {
                                            ...
                                            "stop" === y && (v.each(D, function (e, t) {
                                                p(t, !0)
                                            }),
                                                E.promise && E.resolver(g)),
                                            e();
                                    default:
                                        if (!v.isPlainObject(y) || _.isEmptyObject(y)) {
                                            if (_.isString(y) && C.Redirects[y]) {
                                                var O = (h = v.extend({}, k)).duration
                                                    , A = h.delay || 0;
                                                return !0 === h.backwards && (g = v.extend(!0, [], g).reverse()),
                                                    v.each(g, function (e, t) {
                                                        parseFloat(h.stagger) ? h.delay = A + parseFloat(h.stagger) * e : _.isFunction(h.stagger) && (h.delay = A + h.stagger.call(t, e, T)),
                                                            h.drag && (h.duration = parseFloat(O) || (/^(callout|transition)/.test(y) ? 1e3 : b),
                                                                h.duration = Math.max(h.duration * (h.backwards ? 1 - e / T : (e + 1) / T), .75 * h.duration, 200)),
                                                            C.Redirects[y].call(t, t, h || {}, e, T, g, E.promise ? E : n)
                                                    }),
                                                    e()
                                            }
                                            var I = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                            return E.promise ? E.rejecter(new Error(I)) : console.log(I),
                                                e()
                                        }
                                        S = "start"
                                }
                                ...
                                v.each(g, function (e, t) {
                                    ...
                                    (h = v.extend({}, C.defaults, k)).loop = parseInt(h.loop, 10);
                                var H = 2 * h.loop - 1;
                                if (h.loop)
                                    for (var V = 0; V < H; V++) {
                                        var W = {
                                        ...
                                        V === H - 1 && (W.display = h.display,
                                            W.visibility = h.visibility,
                                            W.complete = h.complete),
                                            M(g, "reverse", W)
                                    }
                                return e()
                            }
                            E.promise && (y && k && !1 === k.promiseRejectEmpty ? E.resolver() : E.rejecter())
                        }
                    };
                    (C = v.extend(M, C)).animate = M;
                    var T = t.requestAnimationFrame || m;
                    ...
                    return e.Velocity = C,
                        ...
                        v.each(["Down", "Up"], function (e, t) {
                            C.Redirects["slide" + t] = function (e, i, s, a, o, r) {
                                var l = v.extend({}, i)
                                    , h = l.begin
                                    , u = l.complete
                                    , d = {}
                        ...
                        v.each(["In", "Out"], function (e, t) {
                            C.Redirects["fade" + t] = function (e, i, s, a, o, r) {
                                var l = v.extend({}, i)
                                    , h = l.complete
                                    , u = {
                                        opacity: "In" === t ? 1 : 0
                                ...
                                0 !== s && (l.begin = null),
                                    l.complete = s !== a - 1 ? null : function () {
                                        h && h.call(o, o),
                                            r && r.resolver(o)
                                    }
                                    ,
    ...
    M.initializeJqueryWrapper = function (e, t, i) {
        jQuery.fn[t] = function (n) {
            if (e.prototype[n]) {
                var s = Array.prototype.slice.call(arguments, 1);
                if ("get" === n.slice(0, 3)) {
                    var a = this.first()[0][i];
                    return a[n].apply(a, s)
                }
    ...
    M.checkWithinContainer = function (e, t, i) {
        ...
        return (r < s.left + i || r < i) && (n.left = !0),
            (r + t.width > s.right - i || r + t.width > window.innerWidth - i) && (n.right = !0),
            (l < s.top + i || l < i) && (n.top = !0),
            (l + t.height > s.bottom - i || l + t.height > window.innerHeight - i) && (n.bottom = !0),
            n
    }
    ,
    M.checkPossibleAlignments = function (e, t, i, n) {
        var s = {
            ...
            , u = i.left - l
            , d = i.top - h;
        return s.spaceOnRight = a ? window.innerWidth - (r.left + i.width) : t.offsetWidth - (u + i.width),
            (!a && u + i.width > t.offsetWidth || a && r.left + i.width > window.innerWidth) && (s.left = !1),
            s.spaceOnLeft = a ? r.right - i.width : u - i.width + r.width,
            (!a && u - i.width + r.width < 0 || a && r.right - i.width < 0) && (s.right = !1),
            s.spaceOnBottom = a ? window.innerHeight - (r.top + i.height + n) : o.height - (d + i.height + n),
            (!a && d + i.height + n > o.height || a && r.top + i.height + n > window.innerHeight) && (s.top = !1),
            s.spaceOnTop = a ? r.bottom - (i.height + n) : d - (i.height + n),
            (!a && d - i.height - n < 0 || a && r.bottom - i.height - n < 0) && (s.bottom = !1),
            s
    }
    ,
    ...
    return function () {
        ...
        return n = this,
            ...
            u <= 0 ? (clearTimeout(o),
                ...
                r = h,
                a = e.apply(n, s),
                n = s = null) : o || !1 === i.trailing || (o = setTimeout(l, u)),
            a
    }
}
    ;
var Vel = void 0;
Vel = M.jQueryLoaded ? jQuery.Velocity : Velocity,
    M.Vel = Vel || Velocity,
    function (e, t) {
        "use strict";
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_Collapsible && t.M_Collapsible.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        this.el.M_Collapsible = this,
                        this.options = e.extend({}, n.defaults, i),
                        this._setupEventHandlers();
                    var s = this.$el.children("li.active").children(".collapsible-body");
                    this.options.accordion ? s.first().css("display", "block") : s.css("display", "block")
                }
                    ...
                    value: function (t) {
                        ...
                        if (t.target && i.length) {
                            ...
                            if (n[0] === this.el) {
                                var s = i.closest("li")
                                    , a = n.children("li")
                                    , o = s[0].classList.contains("active")
                                    , r = a.index(s);
                                o ? this.close(r) : this.open(r)
                            }
                        }
                    }
                }, {
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_Dropdown && t.M_Dropdown.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        this.el.M_Dropdown = this,
                        n._dropdowns.push(this),
                        this.id = M.getIdFromTrigger(t),
                        this.dropdownEl = document.getElementById(this.id),
                        this.$dropdownEl = e(this.dropdownEl),
                        this.options = e.extend({}, n.defaults, i),
                        this.isOpen = !1,
                ...
                return _createClass(n, [{
                    ...
                    value: function (t) {
                        var i = t.toElement || t.relatedTarget
                            ...
                            , s = !1
                            , a = e(i).closest(".dropdown-trigger");
                        a.length && a[0].M_Dropdown && a[0].M_Dropdown.isOpen && (s = !0),
                            s || n || this.close()
                    }
                }, {
                    ...
                    value: function (t) {
                        ...
                        var a = String.fromCharCode(t.which).toLowerCase()
                            , o = [9, 13, 27, 38, 40];
                        if (a && -1 === o.indexOf(t.which)) {
                            this.filterQuery.push(a);
                            var r = this.filterQuery.join("")
                                , l = e(this.dropdownEl).find("li").filter(function (t) {
                                    return 0 === e(t).text().toLowerCase().indexOf(r)
                                })[0];
                            l && (this.focusedIndex = e(l).index(),
                                this._focusFocusedItem())
                        }
                    ...
                    value: function () {
                        -1 === this.dropdownEl.tabIndex && (this.dropdownEl.tabIndex = 0),
                            e(this.dropdownEl).children().attr("tabindex", 0)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        var e = {
                            ...
                            , h = M.checkPossibleAlignments(this.el, l, r, this.options.coverTrigger ? 0 : t.height)
                            , u = "top"
                            , d = this.options.alignment;
                        if (o += this.options.coverTrigger ? 0 : t.height,
                            h.top || (h.bottom ? u = "bottom" : h.spaceOnTop > h.spaceOnBottom ? (u = "bottom",
                                n += h.spaceOnTop,
                                o -= h.spaceOnTop) : n += h.spaceOnBottom),
                            !h[d]) {
                            var c = "left" === d ? "right" : "left";
                            h[c] ? d = c : h.spaceOnLeft > h.spaceOnRight ? (d = "right",
                                s += h.spaceOnLeft,
                                a -= h.spaceOnLeft) : (d = "left",
                                    s += h.spaceOnRight)
                        }
                        return "bottom" === u && (o = o - i.height + (this.options.coverTrigger ? t.height : 0)),
                            "right" === d && (a = a - i.width + t.width),
                        {
                            x: a,
                            y: o,
                            verticalAlignment: u,
                    ...
                    value: function (e) {
                        ...
                        this.dropdownEl.style.left = e.x + "px",
                            ...
                            t(this.dropdownEl, {
                                ...
                                complete: function () {
                                    i._focusFocusedItem(),
                                        "function" == typeof i.options.onOpenEnd && i.options.onOpenEnd.call(i, i.el)
                                }
                            })
                    }
                }, {
                    ...
                    value: function () {
                        if (!this.isOpen) {
                            this.isOpen = !0,
                                null === this.focusedIndex && (this.focusedIndex = 0),
                                "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el),
                                t(this.dropdownEl, "stop"),
                                this._resetDropdownStyles(),
                                t.hook(this.dropdownEl, "display", "block");
                            ...
                            var i = this._getDropdownPosition();
                            this._animateIn(i),
                ...
                return _createClass(n, [{
                    ...
                    value: function () {
                        ...
                        var n = {
                            ...
                            ease: "easeOutCubic",
                            complete: function () {
                                "function" == typeof i.options.ready && i.options.ready.call(i, i.el, i._openingTrigger)
                            }
                        };
                        this.el.classList.contains("bottom-sheet") ? t(this.el, {
                            bottom: 0,
                            opacity: 1
                        }, n) : (t.hook(this.el, "scaleX", .8),
                            t.hook(this.el, "scaleY", .8),
                        ...
                        var i = {
                            ...
                            complete: function () {
                                e.el.style.display = "none",
                                    "function" == typeof e.options.complete && e.options.complete.call(e, e.$el),
                                    e.$overlay.remove()
                            }
                        };
                        this.el.classList.contains("bottom-sheet") ? t(this.el, {
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_Materialbox && t.M_Materialbox.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        ...
                        this.placeholder = e("<div></div>").addClass("material-placeholder"),
                ...
                return _createClass(n, [{
                    ...
                    value: function () {
                        ...
                        this.$el.hasClass("responsive-img") ? (n.maxWidth = [this.newWidth, this.newWidth],
                            n.width = [n.width, this.originalWidth]) : (n.left = [n.left, 0],
                                n.top = [n.top, 0]),
                            t(this.el, n, i)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        this.$overlay.css({
                            ...
                            "" !== this.caption && (this.$photoCaption = e('<div class="materialbox-caption"></div>'),
                                this.$photoCaption.text(this.caption),
                                e("body").append(this.$photoCaption),
                                this.$photoCaption.css({
                                    display: "inline"
                                }),
                                t(this.$photoCaption[0], {
                                    opacity: 1
                                }, {
                                    duration: this.options.inDuration,
                                    queue: !1,
                        ...
                        this.newWidth = 0,
                            this.newHeight = 0,
                            a > o ? (s = this.originalHeight / this.originalWidth,
                    ...
                    value: function () {
                        ...
                        this._updateVars(),
                            this.doneAnimating = !1,
                            t(this.el, "stop"),
                            t(this.$overlay[0], "stop"),
                            "" !== this.caption && t(this.$photoCaption[0], "stop"),
                            ...
                            "" !== this.caption && t(this.$photoCaption[0], {
                                opacity: 0
                            }, {
                                duration: this.options.outDuration,
                                queue: !1,
            ...
            , i = function () {
                function i(t, n) {
                    _classCallCheck(this, i),
                        t.M_Parallax && t.M_Parallax.destroy(),
                        this.el = t,
                        this.$el = e(t),
                ...
                return _createClass(i, [{
                    ...
                    value: function () {
                        var e = this.$el.height() > 0 ? this.el.parentNode.offsetHeight : 500
                            ...
                            , o = t * ((s + a - n) / (e + a));
                        i > s && n < s + a && (this.$img[0].style.transform = "translate3D(-50%, " + o + "px, 0)")
                    }
                }], [{
                    key: "init",
                    value: function (e, t) {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        ...
                        this.options.swipeable ? this._setupSwipeableTabs() : this._setupNormalTabs(),
                        this._setupEventHandlers()
                }
                return _createClass(n, [{
                    key: "destroy",
                        ...
                        if (s.length && s.parent().hasClass("tab"))
                            if (n.hasClass("disabled"))
                                ...
                                this.$activeTabLink = s,
                                    this.$content = e(M.escapeHash(s[0].hash)),
                                    this.$tabLinks = this.$el.children("li.tab").children("a"),
                                ...
                                this.index = Math.max(this.$tabLinks.index(s), 0),
                                    ...
                                    }) : void 0 !== this.$content && (this.$content[0].style.display = "block",
                                        this.$content.addClass("active"),
                                        "function" == typeof this.options.onShow && this.options.onShow.call(this, this.$content[0]),
                                        void 0 === a || a.is(this.$content) || (a[0].style.display = "none",
                    ...
                    value: function () {
                        var t = this;
                        window.innerWidth > options.responsiveThreshold && (this.options.swipeable = !1);
                        var i = e();
                        ...
                        i.first().before(n),
                            n.append(i),
                            i[0].style.display = "",
                            this._tabsCarousel = new M.Carousel(n[0], {
                                fullWidth: !0,
                                noWrap: !0,
                                onCycleTo: function (i) {
                                    ...
                                    t.index = e(i).index(),
                                        ...
                                        t._animateIndicator(n),
                                        "function" == typeof t.options.onShow && t.options.onShow.call(t, t.$content)
                                }
                            })
                    }
                }, {
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_Tooltip && t.M_Tooltip.destroy(),
                        this.el = t,
                        this.$el = e(t),
                ...
                return _createClass(n, [{
                    ...
                    value: function () {
                        ...
                        this.xMovement = 0,
                            ...
                            h = t.offsetTop,
                            u = t.offsetLeft,
                            "top" === this.options.position ? (h += -a - l,
                                u += s / 2 - o / 2,
                                this.yMovement = -this.options.transitionMovement) : "right" === this.options.position ? (h += n / 2 - a / 2,
                                    u += s + l,
                                    this.xMovement = this.options.transitionMovement) : "left" === this.options.position ? (h += n / 2 - a / 2,
                                        u += -o - l,
                                        this.xMovement = -this.options.transitionMovement) : (h += n + l,
                                            u += s / 2 - o / 2,
                                            this.yMovement = this.options.transitionMovement),
                            r = this._repositionWithinScreen(u, h, o, a),
                            e(i).css({
                                top: r.y + "px",
                                left: r.x + "px"
                            })
                    ...
                    value: function (e, t, i, n) {
                        ...
                        return u.left ? o = h : u.right && (o -= o + i - window.innerWidth),
                            u.top ? r = h : u.bottom && (r -= r + n - window.innerHeight),
                        {
                            x: o + s,
                            y: r + a
                        }
                    ...
                    value: function () {
                        var e = {}
                            , t = this.$el[0].getAttribute("data-tooltip")
    ...
    function (e) {
        ...
        function o(t) {
            var i = a(t);
            null !== i && (h.show(t, i),
                "ontouchstart" in e && (i.addEventListener("touchend", h.hide, !1),
                    i.addEventListener("touchcancel", h.hide, !1)),
                i.addEventListener("mouseup", h.hide, !1),
                i.addEventListener("mouseleave", h.hide, !1),
                i.addEventListener("dragend", h.hide, !1))
        }
        var r = r || {}
            ...
            , h = {
                ...
                show: function (e, t) {
                    ...
                    a.className = a.className + " waves-notransition",
                        ...
                        d.transform = u,
                        d.opacity = "1",
                        d["-webkit-transition-duration"] = h.duration + "ms",
                        d["-moz-transition-duration"] = h.duration + "ms",
                        d["-o-transition-duration"] = h.duration + "ms",
                        d["transition-duration"] = h.duration + "ms",
        ...
        r.displayEffect = function (t) {
            "duration" in (t = t || {}) && (h.duration = t.duration),
                h.wrapInput(l(".waves-effect")),
                "ontouchstart" in e && document.body.addEventListener("touchstart", o, !1),
                document.body.addEventListener("mousedown", o, !1)
        }
            ,
            r.attach = function (t) {
                "input" === t.tagName.toLowerCase() && (h.wrapInput([t]),
                    t = t.parentNode),
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t) {
                    _classCallCheck(this, n),
                        this.options = e.extend({}, n.defaults, t),
                ...
                return _createClass(n, [{
                    ...
                    value: function (e) {
                        if (n._draggedToast) {
                            ...
                            t.el.style.transform = "translateX(" + i + "px)",
                                t.el.style.opacity = 1 - Math.abs(i / s)
                        }
                    }
                }, {
                    key: "_onDragEnd",
                    value: function () {
                        if (n._draggedToast) {
                            ...
                            Math.abs(t) > i || e.velocityX > 1 ? (e.wasSwiped = !0,
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_Sidenav && t.M_Sidenav.destroy(),
                        this.el = t,
                        this.$el = e(t),
                ...
                return _createClass(n, [{
                    ...
                    value: function (t) {
                        e(t.target).closest(".sidenav-close").length && this.close()
                    }
                }, {
                    key: "_handleWindowResize",
                    value: function () {
                    ...
                    value: function () {
                        !0 !== this.isOpen && (this.isOpen = !0,
                            "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el),
                            this.isFixed && window.innerWidth > 992 ? (t(this.el, "stop"),
                                t(this.el, {
                                    translateX: 0
                                }, {
                                    duration: 0,
                    ...
                    value: function () {
                        var e = 0;
                        this.isDragged ? e = this.percentOpen : t.hook(this._overlay, "display", "block"),
                            t(this._overlay, "stop"),
                            t(this._overlay, {
                                opacity: [1, e]
                            }, {
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function n(t, i) {
                    _classCallCheck(this, n),
                        t.M_ScrollSpy && t.M_ScrollSpy.destroy(),
                        this.el = t,
                        this.$el = e(t),
                ...
                return _createClass(n, [{
                    key: "destroy",
                    value: function () {
                        n._elements.splice(n._elements.indexOf(this), 1),
                            n._elementsInView.splice(n._elementsInView.indexOf(this), 1),
                            n._visibleElements.splice(n._visibleElements.indexOf(this.$el), 1),
                            n._count--,
                            this._removeEventHandlers(),
                    ...
                    value: function () {
                        ...
                        this._handleThrottledResizeBound = e.bind(this),
                            this._handleWindowScrollBound = this._handleWindowScroll.bind(this),
                            1 === n._count && (window.addEventListener("scroll", this._handleWindowScrollBound),
                    ...
                    key: "_removeEventHandlers",
                    value: function () {
                        0 === n._count && (window.removeEventListener("scroll", this._handleWindowScrollBound),
                    ...
                    key: "_handleTriggerClick",
                    value: function (i) {
                        for (var s = e(i.target), a = n._elements.length - 1; a >= 0; a--) {
                            var o = n._elements[a];
                            if (s.is('a[href="#' + o.$el.attr("id") + '"]')) {
                                i.preventDefault();
                                var r = o.$el.offset().top + 1;
                                t(document.body, "scroll", {
                                    duration: 400,
                                    offset: r - o.options.scrollOffset,
                                    easing: "easeOutCubic"
                                });
                                break
                            }
                    ...
                    value: function () {
                        n._ticks++;
                        for (var e = M.getDocumentScrollTop(), t = M.getDocumentScrollLeft(), i = t + window.innerWidth, s = e + window.innerHeight, a = n._findElements(e, i, s, t), o = 0; o < a.length; o++) {
                            var r = a[o];
                            r.tickId < 0 && r._enter(),
                                r.tickId = n._ticks
                        }
                        for (var l = 0; l < n._elementsInView.length; l++) {
                            var h = n._elementsInView[l]
                                , u = h.tickId;
                            u >= 0 && u !== n._ticks && (h._exit(),
                                h.tickId = -1)
                        }
                        n._elementsInView = a
                    }
                    ...
                    key: "_enter",
                    value: function () {
                        n._visibleElements = n._visibleElements.filter(function (e) {
                            return 0 != e.height()
                        }),
                            n._visibleElements[0] ? (e(this.options.getActiveElement(n._visibleElements[0].attr("id"))).removeClass(this.options.activeClass),
                                n._visibleElements[0][0].M_ScrollSpy && this.id < n._visibleElements[0][0].M_ScrollSpy.id ? n._visibleElements.unshift(this.$el) : n._visibleElements.push(this.$el)) : n._visibleElements.push(this.$el),
                            e(this.options.getActiveElement(n._visibleElements[0].attr("id"))).addClass(this.options.activeClass)
                    }
                }, {
                    key: "_exit",
                    value: function () {
                        ...
                        n._visibleElements = n._visibleElements.filter(function (e) {
                            ...
                            n._visibleElements[0] && (e(this.options.getActiveElement(n._visibleElements[0].attr("id"))).removeClass(this.options.activeClass),
                                ...
                                n._visibleElements[0] && e(this.options.getActiveElement(n._visibleElements[0].attr("id"))).addClass(this.options.activeClass))
                    }
                }], [{
                    key: "init",
                    value: function (e, t) {
                    ...
                    value: function (e, t, i, s) {
                        for (var a = [], o = 0; o < n._elements.length; o++) {
                            var r = n._elements[o]
    ...
    function (e) {
        ...
        var t = {
            ...
            , i = function () {
                function i(t, n) {
                    _classCallCheck(this, i),
                        t.M_Autocomplete && t.M_Autocomplete.destroy(),
                        this.el = t,
                        this.$el = e(t),
                ...
                return _createClass(i, [{
                    ...
                    value: function (e) {
                        ...
                        13 !== e.keyCode && 38 !== e.keyCode && 40 !== e.keyCode && (this.oldVal !== t && (this._removeAutocomplete(),
                    ...
                    value: function (t) {
                        ...
                        13 === n && this.activeIndex >= 0 ? (s = e(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(s),
                            t.preventDefault()) : 38 !== n && 40 !== n || (t.preventDefault(),
                                38 === n && this.activeIndex > 0 && this.activeIndex--,
                                40 === n && this.activeIndex < a - 1 && this.activeIndex++,
                    ...
                    value: function (e, t) {
                        var i = t.find("img")
                            ...
                            , r = t.text().slice(s + 1);
                        t.html("<span>" + a + "<span class='highlight'>" + o + "</span>" + r + "</span>"),
                    ...
                    value: function (t, i) {
                        ...
                        var s = [];
                        for (var a in t)
                            if (t.hasOwnProperty(a) && -1 !== a.toLowerCase().indexOf(i)) {
        ...
        M.updateTextFields = function () {
            ...
            M.validate_field = function (e) {
                var t = null !== e.attr("data-length")
                    ...
                    , n = e[0].value.length;
                0 !== n || !1 !== e[0].validity.badInput || e.is(":required") ? e.hasClass("validate") && (e.is(":valid") && t && n <= i || e.is(":valid") && !t ? (e.removeClass("invalid"),
            ...
            M.textareaAutoResize = function (t) {
                ...
                i.html(r),
                    "hidden" !== t.css("display") ? i.css("width", t.width() + "px") : i.css("width", e(window).width() / 2 + "px"),
                    t.data("original-height") <= i.innerHeight() ? t.css("height", i.innerHeight() + "px") : t[0].value.length < t.data("previous-length") && t.css("height", t.data("original-height") + "px"),
            ...
            e(document).ready(function () {
                        ...
                        n.is("form") && (n.find(t).removeClass("valid").removeClass("invalid"),
                            ...
                            setTimeout(function () {
                                n.find("select").each(function () {
                                    if (this.M_Select) {
                                        var t = e(this).find("option[selected]").text();
                                        e(this).siblings("input.select-dropdown")[0].value = t
                                    }
                                })
                            }, 0))
                    }),
                    document.addEventListener("focus", function (i) {
                        e(i.target).is(t) && e(i.target).siblings("label, .prefix").addClass("active")
                    }, !0),
                ...
                e(".materialize-textarea").each(function () {
                    ...
                    e(document).on("autoresize", ".materialize-textarea", function () {
                        M.textareaAutoResize(e(this))
                    }),
                    e(document).on("change", '.file-field input[type="file"]', function () {
                        for (var t = e(this).closest(".file-field").find("input.file-path"), i = e(this)[0].files, n = [], s = 0; s < i.length; s++)
                            n.push(i[s].name);
                        t[0].value = n.join(", "),
                            t.trigger("change")
                    })
        ...
        var i = {
            ...
            , n = function () {
                function n(i, s) {
                    var a = this;
                    _classCallCheck(this, n),
                        i.M_Slider && i.M_Slider.destroy(),
                        this.el = i,
                        this.$el = e(i),
                        this.el.M_Slider = this,
                        this.options = e.extend({}, n.defaults, s),
                        this.$slider = this.$el.find(".slides"),
                        this.$slides = this.$slider.children("li"),
                        this.activeIndex = this.$slider.find(".active").index(),
                        -1 != this.activeIndex && (this.$active = this.$slides.eq(this.activeIndex)),
                        this._setSliderHeight(),
                        this.$slides.find(".caption").each(function (e) {
                            a._animateCaptionIn(e, 0)
                        }),
                        this.$slides.find("img").each(function (t) {
                            var i = "data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";
                            e(t).attr("src") !== i && (e(t).css("background-image", 'url("' + e(t).attr("src") + '")'),
                                e(t).attr("src", i))
                        }),
                        this._setupIndicators(),
                        this.$active ? this.$active.css("display", "block") : (this.$slides.first().addClass("active"),
                            t(this.$slides.first()[0], {
                                opacity: 1
                            }, {
                                duration: this.options.duration,
                                queue: !1,
                            ...
                            this.options.indicators && this.$indicators.eq(this.activeIndex).addClass("active")),
                        this.$active.find("img").each(function (e) {
                            t(a.$active.find(".caption")[0], {
                                opacity: 1,
                                translateX: 0,
                                translateY: 0
                            }, {
                ...
                return _createClass(n, [{
                    ...
                    value: function (i, n) {
                        ...
                        e(i).hasClass("center-align") ? s.translateY = -100 : e(i).hasClass("right-align") ? s.translateX = 100 : e(i).hasClass("left-align") && (s.translateX = -100),
                            t(i, s, {
                                duration: n,
                                queue: !1
                            })
                    ...
                    value: function (e) {
                        ...
                        if (e >= this.$slides.length ? e = 0 : e < 0 && (e = this.$slides.length - 1),
                            ...
                            this.$active.removeClass("active"),
                                ...
                                t(this.$slides.eq(e).find(".caption")[0], {
                                    opacity: 1,
                                    translateX: 0,
                                    translateY: 0
                                }, {
    ...
    function (e, t) {
        e(document).on("click", ".card", function (i) {
            if (e(this).children(".card-reveal").length) {
                var n = e(i.target).closest(".card");
                void 0 === n.data("initialOverflow") && n.data("initialOverflow", void 0 === n.css("overflow") ? "" : n.css("overflow"));
                var s = e(this).find(".card-reveal");
                e(i.target).is(e(".card-reveal .card-title")) || e(i.target).is(e(".card-reveal .card-title i")) ? t(s, {
                    translateY: 0
                }, {
                    duration: 225,
                    queue: !1,
                ...
                }) : (e(i.target).is(e(".card .activator")) || e(i.target).is(e(".card .activator i"))) && (n.css("overflow", "hidden"),
                    s.css({
                        display: "block"
                    }),
                    t(s, "stop"),
            ...
            , n = function () {
                function t(i, n) {
                    _classCallCheck(this, t),
                        ...
                        this.$input.attr("id") || this.$input.attr("id", M.guid()),
                        this.options.data.length && (this.chipsData = this.options.data,
                            this._renderChips(this.chipsData)),
                        this.hasAutocomplete && this._setupAutocomplete(),
                ...
                return _createClass(t, [{
                    ...
                    value: function () {
                        this._handleChipClickBound = this._handleChipClick.bind(this),
                            ...
                            document.addEventListener("keydown", t._handleChipsKeydown),
                            document.addEventListener("keyup", t._handleChipsKeyup),
                            this.el.addEventListener("blur", t._handleChipsBlur, !0),
                    ...
                    value: function () {
                        this.el.removeEventListener("click", this._handleChipClickBound),
                            document.removeEventListener("keydown", t._handleChipsKeydown),
                            document.removeEventListener("keyup", t._handleChipsKeyup),
                            this.el.removeEventListener("blur", t._handleChipsBlur, !0),
                    ...
                    value: function (t) {
                        if (t.tag) {
                            ...
                            if (i.classList.add("chip"),
                                ...
                                e(n).addClass("material-icons close"),
                                n.textContent = "close",
                                t.image) {
                    ...
                    value: function (t) {
                        this.$chips.eq(t).remove(),
                            ...
                            this._setPlaceholder(),
                            "function" == typeof this.options.onChipDelete && this.options.onChipDelete.call(this, this.$el, this.$chip)
                    }
                }, {
                    key: "selectChip",
                    value: function (e) {
                        ...
                        this._selectedChip = t,
                            t[0].focus(),
                            "function" == typeof this.options.onChipSelect && this.options.onChipSelect.call(this, this.$el, this.$chip)
                    }
                }, {
                    key: "deselectChip",
                    value: function (e) {
                    ...
                    value: function (i) {
                        t._keydown = !0;
                        var n = e(i.target).closest(".chips")
                            , s = i.target && n.length;
                        if (!e(i.target).is("input, textarea") && s) {
                            var a = n[0].M_Chips;
                            if (8 === i.keyCode || 46 === i.keyCode) {
                                i.preventDefault();
                                var o = a.chipsData.length;
                                if (a._selectedChip) {
                                    var r = a._selectedChip.index();
                                    a.deleteChip(r),
                                        a._selectedChip = null,
                                        o = r - 1
                                }
                                a.chipsData.length && a.selectChip(o)
                            ...
                            } else if (39 === i.keyCode && a._selectedChip) {
                                var h = a._selectedChip.index() + 1;
                                h >= a.chipsData.length ? a.$input[0].focus() : a.selectChip(h)
                            }
                        }
                    }
                }, {
                    ...
                    value: function (i) {
                        t._keydown || (e(i.target).closest(".chips")[0].M_Chips._selectedChip = null)
                    }
                }, {
                    key: "defaults",
                    get: function () {
    ...
    function (e) {
        ...
        var t = {
            ...
            , i = function () {
                function i(t, n) {
                    _classCallCheck(this, i),
                        t.M_Pushpin && t.M_Pushpin.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        this.el.M_Pushpin = this,
                        this.options = e.extend({}, i.defaults, n),
                        this.originalOffset = this.el.offsetTop,
                        i._pushpins.push(this),
                        this._setupEventHandlers(),
    ...
    function (e, t) {
        ...
        var n = function () {
            function n(t, i) {
                _classCallCheck(this, n),
                    t.M_FloatingActionButton && t.M_FloatingActionButton.destroy(),
                    this.el = t,
                    this.$el = e(t),
                    ...
                    "top" === this.options.direction ? (this.$el.addClass("direction-top"),
                        this.offsetY = 40) : "right" === this.options.direction ? (this.$el.addClass("direction-right"),
                            this.offsetX = -40) : "bottom" === this.options.direction ? (this.$el.addClass("direction-bottom"),
                                this.offsetY = -40) : (this.$el.addClass("direction-left"),
                                    this.offsetX = 40),
                    this._setupEventHandlers()
            }
            return _createClass(n, [{
                ...
                value: function () {
                    this.$el.addClass("active"),
                        t.hook(this.$floatingBtns, "scaleX", .4),
                        t.hook(this.$floatingBtns, "scaleY", .4),
                        t.hook(this.$floatingBtns, "translateY", this.offsetY + "px"),
                        t.hook(this.$floatingBtns, "translateX", this.offsetX + "px");
                    var e = 0;
                ...
                value: function () {
                    var t = this
                        ...
                        , o = e('<div class="fab-backdrop"></div>')
                        , r = this.$anchor.css("background-color");
                    this.$anchor.append(o),
                        this.offsetX = a.left - n / 2 + a.width / 2,
                        this.offsetY = s - a.bottom,
                        i = n / o[0].clientWidth,
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function t(i, n) {
                    _classCallCheck(this, t),
                        i.M_Datepicker && i.M_Datepicker.destroy(),
                        this.el = i,
                        this.$el = e(i),
                        ...
                        this._setupModal(),
                        this._setupEventHandlers(),
                        this.options.defaultDate || (this.options.defaultDate = new Date(Date.parse(this.el.value)),
                            this.options.setDefaultDate = !0);
                    var s = this.options.defaultDate;
                    t._isDate(s) ? this.options.setDefaultDate ? this.setDate(s, !0) : this.gotoDate(s) : this.gotoDate(new Date),
                        this.isOpen = !1
                }
                return _createClass(t, [{
                    key: "destroy",
                    ...
                    value: function (e) {
                        return e = e || this.options.format,
                            t._isDate(this.date) ? this.options.toString ? this.options.toString(this.date, e) : this.date.toDateString() : ""
                    }
                }, {
                    key: "setDate",
                    value: function (e, i) {
                        ...
                        if ("string" == typeof e && (e = new Date(Date.parse(e))),
                            ...
                            t._isDate(n) && e < n ? e = n : t._isDate(s) && e > s && (e = s),
                                this.date = new Date(e.getTime()),
                                this._renderDateDisplay(),
                                t._setToStartOfDay(this.date),
                                this.gotoDate(this.date),
                                i || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.getDate())
                        }
                    }
                }, {
                    key: "setInputValue",
                    ...
                    value: function () {
                        var e = t._isDate(this.date) ? this.date : new Date
                            , i = this.options.i18n
                            , n = i.weekdaysShort[e.getDay()]
                            , s = i.monthsShort[e.getMonth()]
                            , a = e.getDate();
                        this.yearTextEl.innerHTML = e.getFullYear(),
                            this.dateTextEl.innerHTML = n + ", " + s + " " + a
                    }
                }, {
                    key: "gotoDate",
                    value: function (e) {
                    ...
                    value: function (e, i, n) {
                        var s = this.options
                            , a = new Date
                            , o = t._getDaysInMonth(e, i)
                            , r = new Date(e, i, 1).getDay()
                            , l = []
                            , h = [];
                        t._setToStartOfDay(a),
                            s.firstDay > 0 && (r -= s.firstDay) < 0 && (r += 7);
                        for (var u = 0 === i ? 11 : i - 1, d = 11 === i ? 0 : i + 1, c = 0 === i ? e - 1 : e, p = 11 === i ? e + 1 : e, v = t._getDaysInMonth(c, u), f = o + r, m = f; m > 7;)
                            m -= 7;
                        f += 7 - m;
                        for (var g = !1, y = 0, _ = 0; y < f; y++) {
                            var k = new Date(e, i, y - r + 1)
                                , b = !!t._isDate(this.date) && t._compareDates(k, this.date)
                                , w = t._compareDates(k, a)
                                , C = -1 !== s.events.indexOf(k.toDateString())
                                , E = y < r || y >= o + r
                                , x = y - r + 1
                                , M = i
                                , T = e
                                , L = s.startRange && t._compareDates(s.startRange, k)
                                , $ = s.endRange && t._compareDates(s.endRange, k)
                                , S = s.startRange && s.endRange && s.startRange < k && k < s.endRange
                                , B = s.minDate && k < s.minDate || s.maxDate && k > s.maxDate || s.disableWeekends && t._isWeekend(k) || s.disableDayFn && s.disableDayFn(k);
                            E && (y < r ? (x = v + x,
                                M = u,
                                T = c) : (x -= o,
                                    M = d,
                            ...
                            h.push(this.renderDay(D)),
                                7 == ++_ && (l.push(this.renderRow(h, s.isRTL, g)),
                                    h = [],
                                    _ = 0,
                                    g = !1)
                        }
                    ...
                    value: function (e) {
                        ...
                        return e.isDisabled && t.push("is-disabled"),
                            ...
                            '<td data-day="' + e.day + '" class="' + t.join(" ") + '" aria-selected="' + i + '"><button class="datepicker-day-button" type="button" data-pika-year="' + e.year + '" data-pika-month="' + e.month + '" data-pika-day="' + e.day + '">' + e.day + "</button></td>"
                    }
                }, {
                    key: "renderRow",
                    value: function (e, t, i) {
                        return '<tr class="pika-row' + (i ? " is-selected" : "") + '">' + (t ? e.reverse() : e).join("") + "</tr>"
                    }
                }, {
                    key: "renderTable",
                    value: function (e, t, i) {
                    ...
                    value: function (e) {
                        var t = void 0
                            , i = [];
                        for (t = 0; t < 7; t++)
                            i.push('<th scope="col"><abbr title="' + this.renderDayName(e, t) + '">' + this.renderDayName(e, t, !0) + "</abbr></th>");
                    ...
                    value: function (t, i, n, s, a, o) {
                        var r = void 0
                            ...
                            , d = n === u.minYear
                            , c = n === u.maxYear
                            , p = '<div id="' + o + '" class="datepicker-controls" role="heading" aria-live="assertive">'
                            , v = void 0
                            , f = void 0
                            , m = !0
                            , g = !0;
                        for (h = [],
                            r = 0; r < 12; r++)
                            h.push('<option value="' + (n === a ? r - i : 12 + r - i) + '"' + (r === s ? ' selected="selected"' : "") + (d && r < u.minMonth || c && r > u.maxMonth ? 'disabled="disabled"' : "") + ">" + u.i18n.months[r] + "</option>");
                        for (v = '<select class="pika-select pika-select-month" tabindex="-1">' + h.join("") + "</select>",
                            e.isArray(u.yearRange) ? (r = u.yearRange[0],
                                l = u.yearRange[1] + 1) : (r = n - u.yearRange,
                                    l = 1 + n + u.yearRange),
                            h = []; r < l && r <= u.maxYear; r++)
                            r >= u.minYear && h.push('<option value="' + r + '"' + (r === n ? ' selected="selected"' : "") + ">" + r + "</option>");
                        ...
                        p += '<button class="month-prev' + (m ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg></button>',
                            ...
                            u.showMonthAfterYear ? p += f + v : p += v + f,
                            p += "</div>",
                            d && (0 === s || u.minMonth >= s) && (m = !1),
                            c && (11 === s || u.maxMonth <= s) && (g = !1);
                        return p += '<button class="month-next' + (g ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"/><path d="M0-.25h24v24H0z" fill="none"/></svg></button>',
                            p += "</div>"
                    }
                }, {
                    key: "draw",
                    value: function (e) {
                        if (this.isOpen || e) {
                            ...
                            for (var l = 0; l < 1; l++)
                                this._renderDateDisplay(),
                                    o += this.renderTitle(this, l, this.calendars[l].year, this.calendars[l].month, this.calendars[0].year, r) + this.render(this.calendars[l].year, this.calendars[l].month, r);
                            this.calendarEl.innerHTML = o,
                                new M.Select(this.calendarEl.querySelector(".pika-select-year"), {
                                    classes: "select-year"
                                }),
                                new M.Select(this.calendarEl.querySelector(".pika-select-month"), {
                    ...
                    value: function (t) {
                        if (this.isOpen) {
                            var i = e(t.target);
                            i.hasClass("is-disabled") || (!i.hasClass("datepicker-day-button") || i.hasClass("is-empty") || i.parent().hasClass("is-disabled") ? i.closest(".month-prev").length ? this.prevMonth() : i.closest(".month-next").length && this.nextMonth() : this.setDate(new Date(t.target.getAttribute("data-pika-year"), t.target.getAttribute("data-pika-month"), t.target.getAttribute("data-pika-day"))))
                        }
                    }
                }, {
                    ...
                    value: function (e) {
                        var i = void 0;
                        e.firedBy !== this && (i = this.options.parse ? this.options.parse(this.el.value, this.options.format) : new Date(Date.parse(this.el.value)),
                            t._isDate(i) && this.setDate(i))
                    }
                }, {
                    key: "renderDayName",
                    value: function (e, t, i) {
                    ...
                    value: function (e) {
                        t._isDate(e) && e.setHours(0, 0, 0, 0)
                    }
                }, {
                    key: "_getDaysInMonth",
                    value: function (e, i) {
                        return [31, t._isLeapYear(e) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][i]
                    }
                }, {
                    key: "_isLeapYear",
                    value: function (e) {
    ...
    function (e, t) {
        ...
        var i = {
            ...
            , n = function () {
                function t(i, n) {
                    _classCallCheck(this, t),
                        i.M_Timepicker && i.M_Timepicker.destroy(),
                        this.el = i,
                        this.$el = e(i),
                ...
                return _createClass(t, [{
                    ...
                    value: function (e) {
                        e.preventDefault();
                        var i = this.plate.getBoundingClientRect()
                            , n = {
                                x: i.left,
                                y: i.top
                            };
                    ...
                    value: function () {
                        this.$modalEl = e(t._template),
                            this.modalEl = this.$modalEl[0],
                            this.modalEl.id = "modal-" + this.id;
                        var i = document.querySelector(this.options.container);
                        this.options.container && i ? this.$modalEl.appendTo(i) : this.$modalEl.insertBefore(this.el)
                    }
                }, {
                    key: "_setupModal",
                    value: function () {
                    ...
                    key: "_pickerSetup",
                    value: function () {
                        e('<button class="btn-flat timepicker-clear waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.clearText + "</button>").appendTo(this.footer).on("click", this.clear.bind(this));
                        var t = e('<div class="confirmation-btns"></div>');
                        e('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.cancelText + "</button>").appendTo(t).on("click", this.close.bind(this)),
                            e('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.doneText + "</button>").appendTo(t).on("click", this.done.bind(this)),
                    ...
                    value: function () {
                        var e = this.options.dialRadius
                            , i = this.options.tickRadius
                            , n = 2 * e
                            , s = t._createSVGEl("svg");
                        s.setAttribute("class", "timepicker-svg"),
                            s.setAttribute("width", n),
                            s.setAttribute("height", n);
                        var a = t._createSVGEl("g");
                        a.setAttribute("transform", "translate(" + e + "," + e + ")");
                        var o = t._createSVGEl("circle");
                        o.setAttribute("class", "timepicker-canvas-bearing"),
                            o.setAttribute("cx", 0),
                            o.setAttribute("cy", 0),
                            o.setAttribute("r", 4);
                        var r = t._createSVGEl("line");
                        r.setAttribute("x1", 0),
                            r.setAttribute("y1", 0);
                        var l = t._createSVGEl("circle");
                    ...
                    value: function () {
                        ...
                        if (this.options.twelveHour)
                            for (var i = 1; i < 13; i += 1) {
                                ...
                                n.css({
                                    left: this.options.dialRadius + Math.sin(s) * a - this.options.tickRadius + "px",
                                    top: this.options.dialRadius - Math.cos(s) * a - this.options.tickRadius + "px"
                                }),
                                    n.html(0 === i ? "00" : i),
                            ...
                            for (var o = 0; o < 24; o += 1) {
                                var r = t.clone()
                                    , l = o / 6 * Math.PI
                                    , h = o > 0 && o < 13 ? this.options.innerRadius : this.options.outerRadius;
                                r.css({
                    ...
                    value: function () {
                        for (var i = e('<div class="timepicker-tick"></div>'), n = 0; n < 60; n += 5) {
                            var s = i.clone()
                                , a = n / 30 * Math.PI;
                            s.css({
                    ...
                    value: function () {
                        ...
                        if (this.options.twelveHour && void 0 !== e[1] && (e[1].indexOf("AM") > 0 ? this.amOrPm = "AM" : this.amOrPm = "PM",
                        ...
                        this.hours = +e[0] || 0,
                            ...
                            this.spanMinutes.innerHTML = t._addLeadingZero(this.minutes),
                            this._updateAmPmView()
                    }
                }, {
                    key: "showView",
                    value: function (t, i) {
                        ...
                        var n = "hours" === t
                            ...
                            , a = n ? this.minutesView : this.hoursView;
                        this.currentView = t,
                            e(this.spanHours).toggleClass("text-primary", n),
                            e(this.spanMinutes).toggleClass("text-primary", !n),
                            a.classList.add("timepicker-dial-out"),
                            e(s).css("visibility", "visible").removeClass("timepicker-dial-out"),
                            this.resetClock(i),
                    ...
                    value: function (t) {
                        var i = this.currentView
                            ...
                            , s = "hours" === i
                            , a = n * (Math.PI / (s ? 6 : 30))
                            , o = s && n > 0 && n < 13 ? this.options.innerRadius : this.options.outerRadius
                            , r = Math.sin(a) * o
                            , l = -Math.cos(a) * o
                            , h = this;
                        t ? (e(this.canvas).addClass("timepicker-canvas-out"),
                            setTimeout(function () {
                                e(h.canvas).removeClass("timepicker-canvas-out"),
                                    h.setHand(r, l)
                            }, t)) : this.setHand(r, l)
                    }
                }, {
                    ...
                    value: function (e, i, n) {
                        var s = this
                            ...
                            , r = Math.PI / (o || n ? 6 : 30)
                            , l = Math.sqrt(e * e + i * i)
                            , h = o && l < (this.options.outerRadius + this.options.innerRadius) / 2
                            , u = h ? this.options.innerRadius : this.options.outerRadius;
                        this.options.twelveHour && (u = this.options.outerRadius),
                            a < 0 && (a = 2 * Math.PI + a);
                        var d = Math.round(a / r);
                        a = d * r,
                            this.options.twelveHour ? o ? 0 === d && (d = 12) : (n && (d *= 5),
                                60 === d && (d = 0)) : o ? (12 === d && (d = 0),
                                    d = h ? 0 === d ? 12 : d : 0 === d ? 0 : d + 12) : (n && (d *= 5),
                                        60 === d && (d = 0)),
                            ...
                            o ? this.spanHours.innerHTML = d : this.spanMinutes.innerHTML = t._addLeadingZero(d);
                        var c = Math.sin(a) * (u - this.options.tickRadius)
                            , p = -Math.cos(a) * (u - this.options.tickRadius)
                            , v = Math.sin(a) * u
                            , f = -Math.cos(a) * u;
                    ...
                    value: function (e, i) {
                        var n = this.el.value
                            , s = i ? "" : t._addLeadingZero(this.hours) + ":" + t._addLeadingZero(this.minutes);
                        this.time = s,
                            !i && this.options.twelveHour && (s = s + " " + this.amOrPm),
                            this.el.value = s,
    ...
    function (e) {
        ...
        var t = {}
            , i = function () {
                function i(t, n) {
                    _classCallCheck(this, i),
                        t.M_CharacterCounter && t.M_CharacterCounter.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        this.el.M_CharacterCounter = this,
                        this.options = e.extend({}, i.defaults, n),
                        this.isInvalid = !1,
                        this.isValidLength = !1,
                        this._setupCounter(),
                        this._setupEventHandlers()
                }
                return _createClass(i, [{
        ...
        var t = {
            ...
            , i = function () {
                function i(t, n) {
                    var s = this;
                    _classCallCheck(this, i),
                        t.M_Carousel && t.M_Carousel.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        ...
                        this.dim = 2 * this.itemWidth + this.options.padding || 1,
                        this._autoScrollBound = this._autoScroll.bind(this),
                        this._trackBound = this._track.bind(this),
                        this.options.fullWidth && (this.options.dist = 0,
                            this._setCarouselHeight(),
                            this.showIndicators && this.$el.find(".carousel-fixed-item").addClass("with-indicators")),
                        this.$indicators = e('<ul class="indicators"></ul>'),
                        this.$el.find(".carousel-item").each(function (t, i) {
                            if (s.images.push(t),
                                s.showIndicators) {
                        ...
                        this.showIndicators && this.$el.append(this.$indicators),
                        this.count = this.images.length,
                        this.xform = "transform",
                        ["webkit", "Moz", "O", "ms"].every(function (e) {
                            var t = e + "Transform";
                            return void 0 === document.body.style[t] || (s.xform = t,
                                !1)
                        }),
                        this._setupEventHandlers(),
                ...
                return _createClass(i, [{
                    ...
                    value: function () {
                        ...
                        this._handleCarouselTapBound = this._handleCarouselTap.bind(this),
                            ...
                            this.showIndicators && this.$indicators && (this._handleIndicatorClickBound = this._handleIndicatorClick.bind(this),
                                this.$indicators.find(".indicator-item").each(function (t, i) {
                                    t.addEventListener("click", e._handleIndicatorClickBound)
                                }));
                    ...
                    value: function () {
                        ...
                        void 0 !== window.ontouchstart && (this.el.removeEventListener("touchstart", this._handleCarouselTapBound),
                            ...
                            this.showIndicators && this.$indicators && this.$indicators.find(".indicator-item").each(function (t, i) {
                                t.removeEventListener("click", e._handleIndicatorClickBound)
                            }),
                            window.removeEventListener("resize", this._handleThrottledResizeBound)
                    }
                    ...
                    value: function (t) {
                        ...
                        if (!this.options.fullWidth) {
                            ...
                            0 !== this._wrap(this.center) - i && (t.preventDefault(),
                                t.stopPropagation()),
                                this._cycleTo(i)
                        }
                    }
                    ...
                    value: function (t) {
                        ...
                        if (this.offset = "number" == typeof t ? t : this.offset,
                            ...
                            a = this.offset - this.center * this.dim,
                            o = a < 0 ? 1 : -1,
                            r = -o * a * 2 / this.dim,
                            s = this.count >> 1,
                        ...
                        for ((!this.noWrap || this.center >= 0 && this.center < this.count) && (l = this.images[this._wrap(this.center)],
                            ...
                            l.style[this.xform] = h + " translateX(" + -a / 2 + "px) translateX(" + o * this.options.shift * r * n + "px) translateZ(" + this.options.dist * r + "px)",
                            l.style.zIndex = 0,
                            d = this.options.fullWidth ? 1 : 1 - .2 * r,
                            l.style.opacity = d,
                            l.style.visibility = "visible"),
                            n = 1; n <= s; ++n)
                            this.options.fullWidth ? (u = this.options.dist,
                                d = n === s && a < 0 ? 1 - r : 1) : (u = this.options.dist * (2 * n + r * o),
                                    d = 1 - .2 * (2 * n + r * o)),
                                (!this.noWrap || this.center + n < this.count) && ((l = this.images[this._wrap(this.center + n)]).style[this.xform] = h + " translateX(" + (this.options.shift + (this.dim * n - a) / 2) + "px) translateZ(" + u + "px)",
                                    l.style.zIndex = -n,
                                    l.style.opacity = d,
                                    l.style.visibility = "visible"),
                                this.options.fullWidth ? (u = this.options.dist,
                                    d = n === s && a > 0 ? 1 - r : 1) : (u = this.options.dist * (2 * n - r * o),
                                        d = 1 - .2 * (2 * n - r * o)),
                                (!this.noWrap || this.center - n >= 0) && ((l = this.images[this._wrap(this.center - n)]).style[this.xform] = h + " translateX(" + (-this.options.shift + (-this.dim * n - a) / 2) + "px) translateZ(" + u + "px)",
                                    l.style.zIndex = -n,
                                    l.style.opacity = d,
                                    l.style.visibility = "visible");
                        (!this.noWrap || this.center >= 0 && this.center < this.count) && ((l = this.images[this._wrap(this.center)]).style[this.xform] = h + " translateX(" + -a / 2 + "px) translateX(" + o * this.options.shift * r + "px) translateZ(" + this.options.dist * r + "px)",
                            l.style.zIndex = 0,
                            d = this.options.fullWidth ? 1 : 1 - .2 * r,
                            l.style.opacity = d,
                            l.style.visibility = "visible");
    ...
    function (e) {
        ...
        var t = {}
            , i = function () {
                function i(t, n) {
                    _classCallCheck(this, i),
                        t.M_FeatureDiscovery && t.M_FeatureDiscovery.destroy(),
                        this.el = t,
                        this.$el = e(t),
                        this.el.M_FeatureDiscovery = this,
                        this.options = e.extend({}, i.defaults, n),
                        this.isOpen = !1,
                        this.$origin = e("#" + this.$el.attr("data-target")),
                        this._setup(),
                ...
                return _createClass(i, [{
                    ...
                    key: "getInstance",
                    value: function (e) {
                        return (e.jquery ? e[0] : e).M_FeatureDiscovery
                    }
                }, {
                    key: "defaults",
                    get: function () {
                ...
                return _createClass(i, [{
                    ...
                    value: function (t) {
                        ...
                        var i = e(t.target).closest("li")[0]
                            , n = e(this.dropdownOptions).find("li:not(.optgroup)").index(i);
                        if (!e(i).hasClass("disabled") && !e(i).hasClass("optgroup")) {
                            var s = !0;
                            if (this.isMultiple) {
                                var a = e(i).find('input[type="checkbox"]');
                                a.prop("checked", !a.prop("checked")),
                                    s = this._toggleEntryFromArray(n)
                            } else
                                e(this.dropdownOptions).find("li").removeClass("active"),
                                    e(i).toggleClass("active"),
                                    this.input.value = i.textContent;
                            this._activateOption(e(this.dropdownOptions), i),
                                this.$el.find("option").eq(n).prop("selected", s),
                                this.$el.trigger("change")
                        }
                        t.stopPropagation()
                    }
                    ...
                    value: function () {
                        ...
                        this.wrapper = document.createElement("div"),
                            ...
                            this.$selectOptions.length && this.$selectOptions.each(function (i) {
                                if (e(i).is("option")) {
                                    var n = void 0;
                                    n = t.isMultiple ? t._appendOptionWithIcon(t.$el, i, "multiple") : t._appendOptionWithIcon(t.$el, i),
                                        e(i).prop("selected") && t.$selectedOptions.add(n)
                                } else if (e(i).is("optgroup")) {
                                    var s = e(i).children("option");
                                    e(t.dropdownOptions).append(e('<li class="optgroup"><span>' + i.getAttribute("label") + "</span></li>")[0]),
                                        s.each(function (i) {
                                            var n = t._appendOptionWithIcon(t.$el, i, "optgroup-option");
                                            e(i).prop("selected") && t.$selectedOptions.add(n)
                                        })
                                }
                            }),
                            ...
                            this._setValueToInput();
                        var i = e('<svg class="caret" fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
                        if (this.$el.before(i[0]),
                            !this.el.disabled) {
                            var n = {};
                            this.isMultiple && (n.closeOnClick = !1),
                                this.dropdown = new M.Dropdown(this.input, n)
                        }
                        this._setSelectedStates()
                    }
                }, {
                    ...
                    value: function (t, i, n) {
                        var s = i.disabled ? "disabled " : ""
                            ...
                            , o = this.isMultiple ? '<label><input type="checkbox"' + s + '"/><span>' + i.innerHTML + "</span></label>" : i.innerHTML
                            , r = e("<li></li>")
                            , l = e("<span></span>");
                        l.html(o),
                            r.addClass(s + " " + a),
                        ...
                        if (h) {
                            var u = e('<img alt="" src="' + h + '">');
                            r.prepend(u)
                        }
                        return e(this.dropdownOptions).append(r[0]),
                            r[0]
                    }
                }, {
                    key: "_toggleEntryFromArray",
                    value: function (t) {
                        var i = this.valuesSelected.indexOf(t)
                            , n = -1 === i;
                        return n ? this.valuesSelected.push(t) : this.valuesSelected.splice(i, 1),
                            e(this.dropdownOptions).find("li:not(.optgroup)").eq(t).toggleClass("active"),
                            this.$el.find("option").eq(t).prop("selected", n),
                            n
                    }
                }, {
                    ...
                    value: function () {
                        var t = "";
                        if (this.$el.find("option").each(function (i, n) {
                    ...
                    value: function () {
                        var t = this;
                        this.valuesSelected = [];
                        var i = e(this.dropdownOptions).find("li:not(.optgroup)");
                        this.$el.find("option").each(function (n, s) {
                            var a = i.eq(s);
                            e(n).prop("selected") ? (a.find('input[type="checkbox"]').prop("checked", !0),
                                t._activateOption(e(t.dropdownOptions), a),
                                t.valuesSelected.push(s)) : (a.find('input[type="checkbox"]').prop("checked", !1),
                    ...
                    key: "_activateOption",
                    value: function (t, i) {
                        i && (this.isMultiple || t.find("li.selected").removeClass("selected"),
                    ...
                    value: function (t, n) {
                        ...
                        return t.each(function () {
                            e(this).hasClass("browser-default") || s.push(new i(this, n))
                        }),
                            s
                    }
                }, {
                    key: "getInstance",
                    value: function (e) {
                        return (e.jquery ? e[0] : e).M_Select
                    }
                }, {
                    key: "defaults",
                    get: function () {
                ...
                return _createClass(n, [{
                    ...
                    value: function () {
                        if (!this._mousedown) {
                            ...
                            e(this.thumb).hasClass("active") && (t(this.thumb, "stop"),
                                t(this.thumb, {
                                    height: "0px",
                                    width: "0px",
                                    top: "10px",
                    ...
                    value: function (t, i) {
                        var s = [];
                        return t.each(function () {
                            e(this).hasClass("browser-default") || s.push(new n(this, i))
                        }),
                            s
                    }
                }, {
